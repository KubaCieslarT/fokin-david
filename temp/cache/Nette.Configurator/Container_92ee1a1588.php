<?php
// source: C:\development\xampp\htdocs\app/config/config.neon 
// source: C:\development\xampp\htdocs\app/config/config.local.neon 

class Container_92ee1a1588 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Application\IPresenter' => [['application.1', 'application.2', 'application.3', 'application.4', 'application.5']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\development\xampp\htdocs\app',
			'wwwDir' => 'C:\development\xampp\htdocs\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\development\xampp\htdocs\app/../temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\development\xampp\htdocs\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\development\xampp\htdocs\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\development\xampp\htdocs\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_92ee1a1588 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\development\xampp\htdocs\app/../temp/cache/latte');
